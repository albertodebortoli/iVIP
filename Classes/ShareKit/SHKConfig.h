...
#define SHKMyAppName			@"iVIP"
#define SHKMyAppURL				@"http://www.github.com/albertodebortoli/iVIP"
...
#define SHKTwitterCallbackUrl		@"http://www.github.com/albertodebortoli/iVIP" // You need to set this if using OAuth, see note above (xAuth users can skip it)
